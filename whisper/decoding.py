...
class DecodingTask:
    ...
    def __init__(self, model: "Whisper", options: DecodingOptions):
        ...
        self.sot_index: int = self.initial_tokens.index(50257)
    ...
    def _main_loop(self, audio_features: Tensor, tokens: Tensor):
        ...
        try:
            for i in range(self.sample_len):
                if self.biasing:
                    ...
                    if self.useGPT:
                        # 沒進self.useGPT
                        # Replace Whisper bos token with GPT2 bos tokenZ
                        labels = tokens[:, sotlen-1:].clone()
                    ...
                    # print(f"treetracks:{type(treetracks)}")
                    # treetracks:<class 'list'>
                    # print(f"treetracks:{treetracks[0][0].keys()}")
                    # input()
                ...
                if self.biasing:
                    ...
                    if self.useGPT:
                        ...
                        gen_prob = gen_prob[:, -1:]
                    # trace gen_prob
                    # print(f"gen_prob:{gen_prob}")
                    # input()
                    ptr_gen_complement = tcpgen_dist[:,-1:] * gen_prob
                    # print("check",(tcpgen_dist[:,:-1] * gen_prob).sum(dim=-1))
                    # print(f"gen_prob:{gen_prob[:, 0:1]}")
                    # print('_'*30)
                ...
                if self.biasing:
                    ...
                    # print(f"treetracks:{treetracks}")
                    # trace tree
                    tree_key = treetracks[0][0].keys()
                    # a = list(tree_key)[0]
                    if tree_key:  # 檢查 tree_key 是否非空
                        b = next(iter(tree_key))
                        # print(f"tree_key: {b}")
                        # print(f"treetracks_decode: {tokenizer.decode(b).strip()}")
                        # input()
        ...
        # trace 一整句的token
        # print(f"sentence of tokens:{tokens}")
        # input()
    ...
    def run(self, mel: Tensor) -> List[DecodingResult]:
        ...
        # print(f"tokenizer.decode(t):{tokenizer.decode(t)}")
